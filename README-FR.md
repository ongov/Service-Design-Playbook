...
Ces méthodes de recherche peuvent servir à comprendre les besoins et les comportements des utilisateurs :

| **Quoi** | **Comment** | **Résultat** |
| --- | --- | --- |
| **Entrevues avec des utilisateurs** <br>Utiliser des questions préétablies pour mener des discussions individuelles avec les utilisateurs. | Interroger les utilisateurs et les enregistrer lorsqu&#39;ils décrivent leurs besoins et la façon dont ils utilisent un service. | Comprendre qui sont les utilisateurs, voir les choses de leur point de vue et cultiver de l&#39;empathie à leur égard. |
| **Recherche ethnographique** <br>Observer les utilisateurs et leurs habitudes dans leur environnement naturel. | Suivre les utilisateurs et les observer dans leur routine quotidienne, sans leur donner de tâches précises à accomplir. | Apprendre la manière dont un service s&#39;intègre au quotidien des utilisateurs et si les utilisateurs l&#39;utilisent de leur propre chef. |
| **Tests d&#39;utilisation** <br>Donner aux utilisateurs un service ou un prototype à essayer. | Observer les utilisateurs effectuer des tâches précises en utilisant un prototype et leur demander d&#39;exprimer à haute voix ce qu&#39;ils pensent et font pendant chaque tâche. | Cerner les difficultés et les points faibles pendant l&#39;exécution des tâches et découvrir ce que les utilisateurs pensent pendant qu&#39;ils utilisent un service. |
| **Journaux de bord** Demander aux utilisateurs de consigner leurs réflexions et leurs actions pendant une période plus longue. | Demander aux utilisateurs de soumettre des notes écrites, des photomontages, des enregistrements vidéo ou des publications de médias sociaux. | Découvrir les habitudes quotidiennes des utilisateurs potentiels et recueillir des données sur des processus longs ou imprévisibles. |
...
Transformez les conclusions en idées de manière à orienter la conception du service.

> Si j&#39;avais demandé aux gens ce qu&#39;ils voulaient, ils m&#39;auraient répondu des chevaux plus rapides. [traduction] – _Henry Ford_

Envisagez de documenter la recherche d&#39;une ou plusieurs des façons suivantes :

| **Quoi** | **Comment** | **Résultat** |
| --- | --- | --- |
| **Personas** <br>Créer des personnages fictifs pour représenter les utilisateurs principaux d&#39;un service. | Effectuer des recherches sur divers ensembles d&#39;utilisateurs et créer des mini-biographies décrivant leurs modèles de comportements, leurs croyances, leurs attitudes et leurs difficultés typiques. | Découvrir quels types d&#39;utilisateurs doivent être pris en considération dans le cadre de la conception d&#39;un service et de la prise de décisions s&#39;y rapportant. |
| **Cartographie de parcours** <br>Créer une carte de l&#39;ensemble des expériences que les utilisateurs peuvent avoir tout au long de leur utilisation d&#39;un service. | Dresser un schéma de l&#39;expérience complète d&#39;un utilisateur, de son point de vue, et consigner comment les utilisateurs gèrent divers scénarios dans le cadre d&#39;un service. | Cerner les possibilités d&#39;amélioration du service, écarter des hypothèses sur l&#39;expérience des utilisateurs et cultiver de l&#39;empathie envers les utilisateurs et leur parcours. |
| **Diagrammes d&#39;analyse de service** <br>Créer des diagrammes montrant tous les processus d&#39;exécution soutenant un service. | Présenter les processus, le soutien, les systèmes et les politiques liés à chaque étape d&#39;un service. | Arriver à comprendre le fonctionnement interne du gouvernement et son interaction avec un service. |
| **Diagrammes d&#39;affinité** <br>Regrouper les renseignements afin de dégager des tendances et des idées. | Rassembler les éléments d&#39;information qui se rejoignent et les organiser en groupes. | Déceler des liens inattendus entre divers éléments d&#39;information. |
| **Récits utilisateur** <br>Rédiger de courtes phrases décrivant un besoin de l&#39;utilisateur et sa raison d&#39;être, du point de vue de l&#39;utilisateur. | Rédiger des récits utilisateur selon un modèle simple : En tant que &lt;type d&#39;utilisateur&gt;, je veux &lt;besoin&gt; afin de &lt;raison&gt;. | Découvrir les divers besoins qu&#39;un service doit combler, faire passer l&#39;accent de la création d&#39;exigences détaillées à la discussion des besoins des utilisateurs. |
...
- [concepteur de services](#concepteur-de-services);
- [chercheur sur les utilisateurs](#chercheur-sur-les-utilisateurs);
- [concepteur d&#39;expérience utilisateur](#concepteur-d'expérience-utilisateur);
- [rédacteur de contenu](#rédacteur-de-contenu);
- [expert en la matière](#expert-en-la-matière);
