...
| <img alt="DNA strand metaphor with user needs woven throughout the helix which twists four times, for each phase of service design" src="https://github.com/ongov/Digital-Service-Standard/blob/develop/images/dna-strand2.png" width="100"> | <h3><a href="#alpha-phase">Alpha</a></h3>Developing and testing prototypes with small user groups |
| <img alt="DNA strand metaphor with user needs woven throughout the helix which twists four times, for each phase of service design" src="https://github.com/ongov/Digital-Service-Standard/blob/develop/images/dna-strand3.png" width="100"> | <h3><a href="#beta-phase">Beta</a></h3>Developing at larger scale, making test version available to the public |
| <img alt="DNA strand metaphor with user needs woven throughout the helix which twists four times, for each phase of service design" src="https://github.com/ongov/Digital-Service-Standard/blob/develop/images/dna-strand4.png" width="100"> | <h3><a href="#live-phase">Live</a></h3>Continuing to improve based on user feedback |
